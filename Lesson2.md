...
Pip allows us to install outside packages for our apps. Ensure that after installing and importing in your .py file that there are no underlines indicating the package is not found. If it is not found you are not active in the virtual env.
Running the file
